      ...
      <View style={styles.body} >
        ...
        <View style={styles.container}>
          ...
          <View style={styles.containerTwo}>
            <TextInput style={styles.emailInput} placeholderTextColor="grey" placeholder='username'></TextInput>
          </View>
          <View style={styles.containerTwo}>
            <TextInput style={styles.emailInput} placeholderTextColor="grey" placeholder='Password'></TextInput>
          </View>
          ...
          <View style={styles.containerTwo}>
            <Pressable onPress={login}><Text style={styles.loginButton}>Login</Text></Pressable>
          </View>
          ...
          <View style={styles.createNewAccView}>
            <Text style={styles.DontHaveAcc}>Or Login with </Text>
          </View>
